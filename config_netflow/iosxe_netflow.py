def iosxe_netflow(connection):
    ...
    # Initializes IOS-XE configuration
    iosxe_netflow_config = "Path/to/IOS-XE/config/file"
    connection.send_config_from_file(iosxe_netflow_config)
